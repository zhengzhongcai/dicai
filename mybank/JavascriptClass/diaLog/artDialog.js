...
var count = 0,
	...
	dialogList = {},
	$html = $('html'),
	isFilters = document.documentElement.filters,
	...
	var lock = {
		on: function(){
			...
			ui.dialog.bind('keydown', function(event){
				var key = event.keyCode;
				(key === 9 || key === 38 || key === 40 || key === 8) && $.stopBubble(event);
			});
...
$.fn.dialog.inner = function(win, fn){
	...
	if (win.document.getElementsByTagName('frameset').length !== 0)
		return $.fn.dialog.inner(win.parent, fn);

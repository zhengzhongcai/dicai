...
class Profile extends CI_Controller{
	...
	//	$this->benchmark->mark('code_start');
		...
		// echo "</pre>";
		$state=$this->Profile->getProfileData($post_info,$post_info["playAreaInfo"],"");
		if($state[0]=="false")
		{
	...
	/*function getTemplateID(){
 	...
 	$temGroup_SQL="select TemplateID from template order by TemplateID DESC limit 1";
    ...
    function getProfileID(){
 	$temId = $_POST['temId'];
 	$temGroup_SQL="select ProfileID from profile where TemplateID ='".$temId."'";
		$rs=$this->db->query($temGroup_SQL)->result();
		echo json_encode($rs);
   }*/
}

...
class Resource extends CI_Controller {
	...
	public function tplList()
	{
		...
		$this->load->view('resource/lefter',$data);
		$this->load->view('resource/righter_tpl');
	...
	public function resMananger()
	{
		...
		$this->load->view('footer');
		//$this->load->view('resource/righter_resource.html',$data);
...
AREA;
	...
	public function videoList()
	{
		...
		$this->load->view('header',$data);
		$this->load->view('resource/lefter',$data);
		$this->load->view('resource/righter_video',$data);
		$this->load->view('footer');
	}// func
	...
	public function audioList()
	{
		...
		$this->load->view('header',$data);
		$this->load->view('resource/lefter',$data);
		$this->load->view('resource/righter_audio',$data);
		$this->load->view('footer');
	}// func
	...
	public function picList()
	{
		...
		$this->load->view('header',$data);
		$this->load->view('resource/lefter',$data);
		$this->load->view('resource/righter_pic',$data);
		$this->load->view('footer');
	...
	public function textList()
	{
		...
		$this->load->view('header',$data);
		$this->load->view('resource/lefter',$data);
		$this->load->view('resource/righter_text',$data);
		$this->load->view('footer');
	...
	public function newscate()
	{
		...
		$this->load->view('header',$data);
		$this->load->view('resource/lefter',$data);
		$this->load->view('resource/righter_cate',$data);
		$this->load->view('footer');
	...
	public function newsItem()
	{
		...
		$this->load->view('header',$data);
		$this->load->view('resource/lefter',$data);
		$this->load->view('resource/righter_item',$data);
		$this->load->view('footer');
...
TPL;
	...
	public function rescheck(){
		...
		$this->load->view('header',$data);
		$this->load->view('resource/lefter',$data);
		$this->load->view('resource/righter_check',$data);
		$this->load->view('footer');
	...
	public function commoncfg(){
		...
		$this->load->view('header',$data);
		$this->load->view('resource/lefter',$data);
		$this->load->view('resource/righter_cfg',$data);
		$this->load->view('footer');

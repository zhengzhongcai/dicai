...
if ( ! function_exists('uploadFile')){
	function uploadFile($save_path, $fileName, $type = 'text'){
		...
		// Settings
			...
			switch($type){
				case 'video':
					...
					break;
				case 'audio':
					$extension_whitelist = array('mp3');
					break;
				case 'pic':
					$extension_whitelist = array('jpg');
					break;
				case 'text':
					$extension_whitelist = array('txt');
					break;
			}// switch
		...
		// Process the file
			...
			*/
			...
			if (file_exists($save_path.$file_name)) @unlink($save_path.$file_name);	// 删除同名文件

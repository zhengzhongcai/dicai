...
function ckstyle() { //定义总的风格
	...
	*/
	...
	/*以下是播放器自带的二个插件*/
	ck.control_rel='null,ckplayer/related.xml,0';
	...
	*/
	ck.setup='0,0,0,0,1,1,0,1,2,0,1,1,200,0,1,1,0,1,1,1,0,10,3';
	/*
	总体设置：
	...
	*/
	...
	/*缓冲文本框(提示加载百分比)的坐标*/
	ck.pm_ctbar='1,2,0,0,0,0,0,2,0.1';
	/*
	...
	*/
	ck.pm_clock='-200,-200,100,-25,2,0,0';
	/*
	...
	*/
	...
	ck.pm_full='-200,-200,-35,-30,0,0';
	/*
		1,2,3,4、全屏和取消全屏按钮的坐标
		5、宽度
		6、高度
	*/
	ck.pm_vol='-200,-200,-95,-18,53,4,6,12';
	/*
	音量调节框的坐标
		1,2,3,4、坐标控制
		5、音量控制区域的宽度
		...
		8、拖动按钮的高度
	*/
	ck.pm_sound='-200,-200,-130,-30,35,30';
	/*
		1,2,3,4、静音和取消静音的坐标
		5、宽度
		6、高度

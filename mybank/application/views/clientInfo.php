...
<script language="JavaScript1.5" src="JavascriptClass/jquery-1.7.2.js" type="text/javascript"></script>
...
<script type="text/javascript" src="JavascriptClass/jquery-easyui/jquery.linkButton-issue.js"></script>
...
<div id="ifarmetop" style="width:99%; min-width:980px; margin:0 auto; border:1px  #195186 solid; border-top:0px; height:300px; overflow:hidden; visibility:inherit" >
  ...
  <div id="right_click_memu" class="easyui-menu"  style="width:120px;">
    <!--<div id="right_click_memu_add_group" data-options="name:'add_group'">添加分组</div>
    <div data-options="name:'new_sub_group'">添加子分组</div>
    <div data-options="name:'remove_group'">删除分组</div>
    <div class="menu-sep"></div>
    <div >
        <span>open</span>
        <div id="right_click_memu_move_client" >
          <div data-options="name:'move_client',iconCls:'icon-print'">分组1</div>
        </div>
    </div>
    <div >
      <span>移动选择终端</span>
      <div id="right_click_memu_move_select_client">
        <div data-options="name:'move_client',iconCls:'icon-print'">分组1</div>
      </div>

    </div>
    <div data-options="name:'remove_client',iconCls:'icon-print'">删除终端</div>
    <div data-options="name:'remove_select_client',iconCls:'icon-print'">删除选中终端</div>
    <div class="menu-sep"></div>

  ...
  <div class="left_box">
    <div class="left_menu">
      ...
      <div class="left_menu_tab">
        <ul>
          <li class="li1" style="width:100%"><a href="<?php echo $session['baseurl']; ?>/index.php?control=device" class="on">组织架构</a></li>
        </ul>
      </div>
      ...
      <div class="left_menu_tab">
        <ul>
          <li class="li1" style="width:100%"><a href="<?php echo $session['baseurl']; ?>/index.php?control=device&action=adMachine" class="on">广告机器</a></li>
        </ul>
      </div>
    </div>
        </div>

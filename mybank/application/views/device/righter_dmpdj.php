	...
	<div class="right_box">  
		...
		<div class="mod_tab1">
			<ul><li><a href="javascript:showManage('getDmpdjList')">取号主机</a></li><li><a href="javascript:showManage('getDmpdjmanage')">业务管理</a></li><li><a href="javascript:showManage()">取票导航</a></li><li><a href="#">验证信息</a></li><li><a href="javascript:showManage('getVipmanage')">VIP管理</a></li><li><a href="#">预约信息</a></li>
		...
		<div class="mob_tool">
			...
			<select id="deviceType" name="deviceType" onchange="changeDevice()">
				...
				<option value="Dmpdj" selected>排队机</option>

var program = {
    ...
    editprofile: function(editobjs) {
        ...
        var id = editobjs.id;
        var name = editobjs.name;
        art.dialog.open('./template/JavaScriptProduct/JavaScriptCreateMode/createProfile.html?profile_id=' + id + '&profileName=' + name + '&edit_type=edit', {
            title: '编辑节目',
            width: 980,
            height: 549,
            padding: 0,

...
// 正常图标
var normal_icon_url = "<{$baseUrl}>/assets/images/icon_coordinate_green.png";
// 一级预警图标
var onelevel_icon_url = "<{$baseUrl}>/assets/images/icon_coordinate_red.png";
// 二级预警图标
var twolevel_icon_url = "<{$baseUrl}>/assets/images/icon_coordinate_orange.png";
// 三级预警图标
var threelevel_icon_url = "<{$baseUrl}>/assets/images/icon_coordinate_yellow.png";
...
function setJgWaitIcon(){
	...
	var url="<{$baseUrl}>/index.php?control=monitor&action=getWaitMaxList";
	$.ajax({
		type: "post",
		url: url,
		data: "",
...
function setJgPjhcIcon(){
	...
	var url="<{$baseUrl}>/index.php?control=monitor&action=getPjhcMaxList";
	$.ajax({
		type: "post",
		url: url,
		data: "",
...
function setJgWaitcsIcon(){
	...
	var url="<{$baseUrl}>/index.php?control=monitor&action=getWaitCsMaxList";
	$.ajax({
		type: "post",
		url: url,
		data: "",
...
function setJgblcsIcon(){
	...
	var url="<{$baseUrl}>/index.php?control=monitor&action=getBlCsMaxList";
	$.ajax({
		type: "post",
		url: url,
		data: "",

...
<script type="text/javascript" src="application/views/javaScript/programManage.js"></script>
...
<div id="toolbar" >
	    ...
	    <a id="add" class="easyui-linkbutton" plain="true" iconCls="icon-add" onclick="program.createprofile()">新建节目</a>

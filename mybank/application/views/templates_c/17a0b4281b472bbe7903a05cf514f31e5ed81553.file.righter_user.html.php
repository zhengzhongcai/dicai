<?php /* Smarty version Smarty-3.1.8, created on 2017-03-31 11:18:42
         compiled from "D:\bankSct2\BANK\application/views\authority\righter_user.html" */ ?>
<?php /*%%SmartyHeaderCode:1034558c8a0cd19bf31-89531869%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '17a0b4281b472bbe7903a05cf514f31e5ed81553' => 
    array (
      0 => 'D:\\bankSct2\\BANK\\application/views\\authority\\righter_user.html',
      1 => 1490930320,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1034558c8a0cd19bf31-89531869',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_58c8a0cd369564_94342977',
  'variables' => 
  array (
    'COMMON_ADD' => 0,
    'COMMON_EDIT' => 0,
...
<?php if ($_valid && !is_callable('content_58c8a0cd369564_94342977')) {function content_58c8a0cd369564_94342977($_smarty_tpl) {?>	<!----right---->
	<div class="right_box">  
		<!----title 标题栏 标签---->
		...
		<!----tool 工具条---->
		<div class="mob_tool">
			<a auth="209" href="javascript:showPopbox()" class="tool_add statItem"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['COMMON_ADD']->value)===null||$tmp==='' ? "添加" : $tmp);?>
</a>
			<a auth="210" href="javascript:editParamInfo()" class="tool_edit statItem"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['COMMON_EDIT']->value)===null||$tmp==='' ? "编辑" : $tmp);?>
</a>
			<a auth="211" href="javascript:deleteParamInfo()" class="tool_del statItem"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['COMMON_DEL']->value)===null||$tmp==='' ? "删除" : $tmp);?>
</a>
		</div>
		<!----tool 工具条 end---->
		<script>
...
?>
				$('a[auth="<?php echo $_smarty_tpl->tpl_vars['row']->value['menurole_id'];?>

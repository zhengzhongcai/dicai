<?php /* Smarty version Smarty-3.1.8, created on 2013-08-20 14:27:10
         compiled from "G:\WWW\webmark\application/views\device\righter_dmpdj.html" */ ?>
<?php /*%%SmartyHeaderCode:3015052130c3eacc6d7-22021820%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '62f4f770513c9d6d6e34db79bf0c9da832c3fbde' => 
    array (
      0 => 'G:\\WWW\\webmark\\application/views\\device\\righter_dmpdj.html',
      1 => 1376644554,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3015052130c3eacc6d7-22021820',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52130c3ede1e62_75062394',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52130c3ede1e62_75062394')) {function content_52130c3ede1e62_75062394($_smarty_tpl) {?>	<input id="orgId" type="hidden"/>
	<!----right---->
	<div class="right_box">  
		<!----tab 标签页---->
		<div class="mod_tab">
...
/index.php?control=device&action=getDmpdjInfos";
	...
	function generateDevice(deviceInfo){
		var paramStr = '<tr>'+
						  '<td class="tc"><input id="'+hex_md5(deviceInfo.PDJ_mac)+'" class="optCheck" type="checkbox"/></td>'+
		...
		$('#'+paramId).parent().nextAll().each(function(){
			...
			switch (i){
				case 1:
					...
					$(this).html('<input type="text" name="PDJ_mac" value="'+content+'"/>');
					break;
				case 2:

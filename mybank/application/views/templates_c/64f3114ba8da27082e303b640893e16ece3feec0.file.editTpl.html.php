<?php /* Smarty version Smarty-3.1.8, created on 2013-11-04 17:14:58
         compiled from "G:\WWW\webmark\application/views\resource\editTpl.html" */ ?>
<?php /*%%SmartyHeaderCode:41745212ca0a31b583-27710455%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '64f3114ba8da27082e303b640893e16ece3feec0' => 
    array (
      0 => 'G:\\WWW\\webmark\\application/views\\resource\\editTpl.html',
      1 => 1383556496,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '41745212ca0a31b583-27710455',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5212ca0aa83c14_25013389',
  'variables' => 
  array (
    'COMMON_RES_VIDEO' => 0,
    'rVideos' => 0,
...
<?php if ($_valid && !is_callable('content_5212ca0aa83c14_25013389')) {function content_5212ca0aa83c14_25013389($_smarty_tpl) {?>	<!----right---->
...
?>
				<div class="item" id="<?php echo $_smarty_tpl->tpl_vars['video']->value['id'];?>
...
?>
				<div class="item" id="<?php echo $_smarty_tpl->tpl_vars['audio']->value['id'];?>
...
?>
				<div class="item" id="<?php echo $_smarty_tpl->tpl_vars['pic']->value['id'];?>
...
?>
				<div class="item" id="<?php echo $_smarty_tpl->tpl_vars['text']->value['id'];?>
...
';
		...
		Area.prototype.render = function(){
			...
			for (var idx in this.resArr){
				...
				var newSpan = $('<span>'+item.resname+'</span>');
				$(newLi).append(newA);
...
/index.php?control=resource&action=storeTpl";
			$.ajax({
				type: "post",
				url: url,
				data: 'tpl_name='+tpl_name+'&areas='+encodeURIComponent(JSON.stringify(items))+'&resolution='+resolution+'&version='+version,
				success: function(data) {
...
/index.php?control=resource&action=updateTpl";
			$.ajax({
				type: "post",
				url: url,
				data: 'tplid='+tplid+'&tpl_name='+tpl_name+'&areas='+encodeURIComponent(JSON.stringify(items))+'&resolution='+resolution+'&version='+version,
				success: function(data) {

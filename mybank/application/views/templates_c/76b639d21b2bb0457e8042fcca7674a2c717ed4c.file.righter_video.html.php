<?php /* Smarty version Smarty-3.1.8, created on 2017-03-27 17:27:22
         compiled from "D:\bankSct2\BANK\application/views\resource\righter_video.html" */ ?>
<?php /*%%SmartyHeaderCode:1956058d8dafa0ac3b0-28062368%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '76b639d21b2bb0457e8042fcca7674a2c717ed4c' => 
    array (
      0 => 'D:\\bankSct2\\BANK\\application/views\\resource\\righter_video.html',
      1 => 1390443066,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1956058d8dafa0ac3b0-28062368',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58d8dafa25db73_91657369',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58d8dafa25db73_91657369')) {function content_58d8dafa25db73_91657369($_smarty_tpl) {?>	<!----right---->
	<div class="right_box">
		<!----tool 工具条---->
		<div class="mob_tool">
			...
			<table id="tbCommonPram">
				<thead>
					<tr>
						...
						<th width="10%"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['RES_RIGHTER_TABLE_FILESIZE']->value)===null||$tmp==='' ? "文件大小" : $tmp);?>
</th>
...
<div class="pop_box" style="display:none">
	<div class="pop_title">
		<h3><?php echo (($tmp = @$_smarty_tpl->tpl_vars['RES_RIGHTER_VIDEO_ADD']->value)===null||$tmp==='' ? "添加视频" : $tmp);?>
</h3>
...
" onclick="swfu.cancelQueue();" disabled="disabled"/>
					...
					<div><?php echo (($tmp = @$_smarty_tpl->tpl_vars['RES_RIGHTER_VIDEO_UPLOAD']->value)===null||$tmp==='' ? "请上传MP4文件" : $tmp);?>
</div>
				</td>
			</tr>
		</table>
...
/index.php?control=resource&action=uploadRes",
			...
			post_params: {"PHPSESSID" : "", "res_type":"0"},
...
/index.php?control=resource&action=storeRes";
		$.ajax({
			type: "post",
			url: url,
			data: 'res_type=0&res_name='+resname,
			success: function(data) {
				if (data > 0) {
...
/index.php?control=resource&action=updateRes";
		$.ajax({
			type: "post",
			url: url,
			data: 'res_type=0&res_name='+resname+'&resid='+resid,
			success: function(data) {
				if (data > 0) {

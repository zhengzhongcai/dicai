<?php /* Smarty version Smarty-3.1.8, created on 2013-08-20 14:27:15
         compiled from "G:\WWW\webmark\application/views\device\righter_pad.html" */ ?>
<?php /*%%SmartyHeaderCode:1063152130c439cf7d5-57035477%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8a51c4a2f8b853e89bd95bc46cdc41f27417a8a9' => 
    array (
      0 => 'G:\\WWW\\webmark\\application/views\\device\\righter_pad.html',
      1 => 1376646143,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1063152130c439cf7d5-57035477',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52130c43bc8ce1_63422979',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52130c43bc8ce1_63422979')) {function content_52130c43bc8ce1_63422979($_smarty_tpl) {?>	<input id="orgId" type="hidden"/>
	<!----right---->
	<div class="right_box">  
		<!----tab 标签页---->
		<div class="mod_tab">
...
/index.php?control=device&action=getPadInfos";
	...
	function generateDevice(deviceInfo){
		var paramStr = '<tr>'+
						  '<td class="tc"><input id="'+hex_md5(deviceInfo.PAD_mac)+'" class="optCheck" type="checkbox"/></td>'+
		...
		$('#'+paramId).parent().nextAll().each(function(){
			...
			switch (i){
				case 1:
					...
					$(this).html('<input type="text" name="PAD_mac" value="'+content+'"/>');
					break;
				case 2:

<?php /* Smarty version Smarty-3.1.8, created on 2013-11-15 18:24:24
         compiled from "G:\WWW\webmark\application/views\resource\righter_text.html" */ ?>
<?php /*%%SmartyHeaderCode:247895270b16f8cf005-86280502%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a1058aa1dbb4d4531d989f3e81f74484dd980c37' => 
    array (
      0 => 'G:\\WWW\\webmark\\application/views\\resource\\righter_text.html',
      1 => 1384511061,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '247895270b16f8cf005-86280502',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5270b16fab3627_10222602',
  'variables' => 
  array (
...
<?php if ($_valid && !is_callable('content_5270b16fab3627_10222602')) {function content_5270b16fab3627_10222602($_smarty_tpl) {?>	<!----right---->
	<div class="right_box">
		<!----tool 工具条---->
		<div class="mob_tool">
			<a auth="c" href="javascript:showPopbox('addRes')" class="tool_add statItem"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['RES_RIGHTER_TEXT_ADD']->value)===null||$tmp==='' ? "添加文本" : $tmp);?>
</a>
			...
			<table id="tbCommonPram">
				<thead>
					<tr>
						...
						<th width="10%"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['RES_RIGHTER_TABLE_FILENAME']->value)===null||$tmp==='' ? "文件名称" : $tmp);?>
</th>
...
<div class="pop_box" style="display:none">
	<div class="pop_title">
		<h3><?php echo (($tmp = @$_smarty_tpl->tpl_vars['RES_RIGHTER_TEXT_ADD']->value)===null||$tmp==='' ? "添加文本" : $tmp);?>
</h3>
...
" onclick="swfu.cancelQueue();" disabled="disabled"/>
					...
					<div><?php echo (($tmp = @$_smarty_tpl->tpl_vars['RES_RIGHTER_TEXT_UPLOAD']->value)===null||$tmp==='' ? "请上传txt文件" : $tmp);?>
</div>
				</td>
			</tr>
		</table>
...
/index.php?control=resource&action=uploadRes",
			...
			post_params: {"PHPSESSID" : "", "res_type":"3"},
...
/index.php?control=resource&action=storeRes";
		$.ajax({
			type: "post",
			url: url,
			data: 'res_type=3&res_name='+resname,
			success: function(data) {
				if (data > 0) {
...
/index.php?control=resource&action=updateRes";
		$.ajax({
			type: "post",
			url: url,
			data: 'res_type=3&res_name='+resname+'&resid='+resid,
			success: function(data) {
				if (data > 0) {

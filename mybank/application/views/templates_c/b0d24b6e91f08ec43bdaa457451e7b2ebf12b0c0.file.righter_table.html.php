<?php /* Smarty version Smarty-3.1.8, created on 2013-10-23 18:05:09
         compiled from "G:\WWW\webmark\application/views\statistic\righter_table.html" */ ?>
<?php /*%%SmartyHeaderCode:118245211d6e66d5158-95878838%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b0d24b6e91f08ec43bdaa457451e7b2ebf12b0c0' => 
    array (
      0 => 'G:\\WWW\\webmark\\application/views\\statistic\\righter_table.html',
      1 => 1382522702,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '118245211d6e66d5158-95878838',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_5211d6e6b46799_98921275',
  'variables' => 
  array (
    'STAT_RIGHTER_TABLE_DAY' => 0,
    'STAT_RIGHTER_TABLE_MONTH' => 0,
    'STAT_RIGHTER_TABLE_SEASON' => 0,
    'STAT_RIGHTER_TABLE_YEAR' => 0,
    'timeControl' => 0,
    'STAT_RIGHTER_TABLE_TO' => 0,
    'STAT_RIGHTER_TABLE_SELECT' => 0,
...
<?php if ($_valid && !is_callable('content_5211d6e6b46799_98921275')) {function content_5211d6e6b46799_98921275($_smarty_tpl) {?>	<input type="hidden" id="orgId"/>
		...
		<div class="mob_search" style="width:auto;">
			<form method="post">
				<select id="selectType" onchange="changeType()">
					<option value="day"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['STAT_RIGHTER_TABLE_DAY']->value)===null||$tmp==='' ? "日期" : $tmp);?>
</option>
					<option value="month"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['STAT_RIGHTER_TABLE_MONTH']->value)===null||$tmp==='' ? "月份" : $tmp);?>
</option>
					<option value="season"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['STAT_RIGHTER_TABLE_SEASON']->value)===null||$tmp==='' ? "季度" : $tmp);?>
</option>
					<option value="year"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['STAT_RIGHTER_TABLE_YEAR']->value)===null||$tmp==='' ? "年份" : $tmp);?>
</option>
				</select>
				<span id="starttime" style="display:inline-block">
					<?php echo $_smarty_tpl->tpl_vars['timeControl']->value;?>

				</span>
				&nbsp;&nbsp;<?php echo (($tmp = @$_smarty_tpl->tpl_vars['STAT_RIGHTER_TABLE_TO']->value)===null||$tmp==='' ? "至" : $tmp);?>
&nbsp;&nbsp;
				<span id="endtime" style="display:inline-block">
					<?php echo $_smarty_tpl->tpl_vars['timeControl']->value;?>

				</span>
				<a href="javascript:void(0)" class="btn_orange" onclick="selectData()"/><?php echo (($tmp = @$_smarty_tpl->tpl_vars['STAT_RIGHTER_TABLE_SELECT']->value)===null||$tmp==='' ? "查询" : $tmp);?>
</a>
			</form>
		</div>
      <!----mob_search end----> 

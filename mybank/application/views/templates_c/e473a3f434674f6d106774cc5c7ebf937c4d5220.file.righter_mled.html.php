<?php /* Smarty version Smarty-3.1.8, created on 2017-04-06 15:52:06
         compiled from "D:\bankSct2\BANK\application/views\device\righter_mled.html" */ ?>
<?php /*%%SmartyHeaderCode:884158da27970353d2-17227097%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e473a3f434674f6d106774cc5c7ebf937c4d5220' => 
    array (
      0 => 'D:\\bankSct2\\BANK\\application/views\\device\\righter_mled.html',
      1 => 1490866943,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '884158da27970353d2-17227097',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_58da279713dba1_50104972',
  'variables' => 
  array (
    ...
    'DEVICE_RIGHTER_MLED_ADDR' => 0,
    'DEVICE_RIGHTER_MLED_WIN_SERIAL' => 0,
    'DEVICE_RIGHTER_MANU' => 0,
    'DEVICE_RIGHTER_PHONE' => 0,
    'DEVICE_RIGHTER_DIRECTOR' => 0,
    'DEVICE_RIGHTER_REMARK' => 0,
    'DEVICE_RIGHTER_MLED_POPBOX_TITLE' => 0,
    'COMMON_BOX_SAVA' => 0,
    'COMMON_BOX_CANCEL' => 0,
...
<?php if ($_valid && !is_callable('content_58da279713dba1_50104972')) {function content_58da279713dba1_50104972($_smarty_tpl) {?>	<input id="orgId" type="hidden"/>
	<input id="device_key" type="hidden" value="mled"/>
	<!----right---->
	<div class="right_box">  
		<!----tab 标签页---->
		<div class="mod_tab">
...
:</span>
			<select id="deviceType" name="deviceType" onchange="changeDevice()">
				...
				<option value="Mled" selected><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_TOOL_MLED']->value)===null||$tmp==='' ? "主LED" : $tmp);?>
</option>
			...
			上线:<b id="onlineMledTotal">0</b>台&nbsp;&nbsp;
			未上线:<b id="unlineMledTotal">0</b>台&nbsp;&nbsp;
			总计:<b id="mledTotal">0</b>台&nbsp;&nbsp;
		</div>
		<!----tool 工具条 end---->
		<script>
			...
			<table id="tbDevice">
				<thead>
					<tr>
						...
						<th width="20%"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MLED_ADDR']->value)===null||$tmp==='' ? "地址" : $tmp);?>
</th>
						<th width="5%"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MLED_WIN_SERIAL']->value)===null||$tmp==='' ? "窗口序列" : $tmp);?>
</th>
						...
						<th width="20%"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_REMARK']->value)===null||$tmp==='' ? "备注" : $tmp);?>
</th>
						<!--
						<th width="10%">录入时间</th>
						<th width="10%">修改时间</th>
...
<!--content end-->
<div id="mled_pop_box" class="pop_box" style="display:none">
	<div class="pop_title">
		<h3><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MLED_POPBOX_TITLE']->value)===null||$tmp==='' ? "添加主LED" : $tmp);?>
</h3>
...
:</th>
				<td><input name="mLed_mac" type="text" style="width:160px" /></td>
			</tr>
			<tr>
				<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MLED_ADDR']->value)===null||$tmp==='' ? "地址" : $tmp);?>
:</th>
				<td><input name="mLed_addr" type="number" style="width:160px" /></td>
			</tr>
			<tr>
				<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MLED_WIN_SERIAL']->value)===null||$tmp==='' ? "窗口序列" : $tmp);?>
:</th>
				<td><input name="mLed_counterNoArray" type="text" style="width:160px" /></td>
			</tr>
			<tr>
				<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MANU']->value)===null||$tmp==='' ? "制造商" : $tmp);?>
:</th>
				<td><input name="mled_zzsname" type="text" style="width:160px" /></td>
			</tr>
			<tr>
				<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_PHONE']->value)===null||$tmp==='' ? "联系电话" : $tmp);?>
:</th>
				<td><input name="mled_zzsPhone" type="text" style="width:160px" /></td>
			</tr>
			<tr>
				<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_DIRECTOR']->value)===null||$tmp==='' ? "负责人" : $tmp);?>
:</th>
				<td><input name="mled_fze" type="text" style="width:160px" /></td>
			</tr>
			<tr>
				<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_REMARK']->value)===null||$tmp==='' ? "备注" : $tmp);?>
:</th>
				<td><textarea name="mled_bz" rows="4" cols="30"></textarea></td>
			</tr>
		</table>
		<div class="pop_foot">
...
&nbsp;&nbsp;" class="btn_gray" />&nbsp;
	...
	<div id="mled_update_box" class="pop_box" style="display:none">
		<div class="pop_title">
			<h3><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MLED_POPBOX_TITLE']->value)===null||$tmp==='' ? "添加主LED" : $tmp);?>
</h3>
			<a href="javascript:hidePopbox()" class="pop_close"></a>
		...
		<div class="pop_body tbAddParamInfo">
			<table>
				<tr>
					<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MAC']->value)===null||$tmp==='' ? "MAC地址" : $tmp);?>
:</th>
					<td><input id="update_mLed_mac" disabled name="mLed_mac" type="text" style="width:160px" /></td>
				</tr>
				<tr>
					<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MLED_ADDR']->value)===null||$tmp==='' ? "地址" : $tmp);?>
:</th>
					<td><input id="update_mLed_addr" name="mLed_addr" type="number" style="width:160px" /></td>
				</tr>
				<tr>
					<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MLED_WIN_SERIAL']->value)===null||$tmp==='' ? "窗口序列" : $tmp);?>
:</th>
					<td><input id="update_mLed_counterNoArray"  name="mLed_counterNoArray" type="text" style="width:160px" /></td>
				</tr>
				<tr>
					<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MANU']->value)===null||$tmp==='' ? "制造商" : $tmp);?>
:</th>
					<td><input id="update_mled_zzsname" name="mled_zzsname" type="text" style="width:160px" /></td>
				</tr>
				<tr>
					<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_PHONE']->value)===null||$tmp==='' ? "联系电话" : $tmp);?>
:</th>
					<td><input id="update_mled_zzsPhone" name="mled_zzsPhone" type="text" style="width:160px" /></td>
				</tr>
				<tr>
					<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_DIRECTOR']->value)===null||$tmp==='' ? "负责人" : $tmp);?>
:</th>
					<td><input id="update_mled_fze" name="mled_fze" type="text" style="width:160px" /></td>
				</tr>
				<tr>
					<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_ORG']->value)===null||$tmp==='' ? "机构" : $tmp);?>
:</th>
					<td>
						<ul id="mled_rr" class="filetree">
				...
				<tr>
					<th scope="row"><?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_REMARK']->value)===null||$tmp==='' ? "备注" : $tmp);?>
:</th>
					<td><textarea id="update_mled_bz" name="mled_bz" rows="4" cols="30"></textarea></td>
				</tr>
			</table>
			<div class="pop_foot">
...
';
		...
		$("#mled_rr").treeview({collapsed: true,});
...
/index.php?control=device&action=getOrgInfo";
	...
	// 弹出添加输入框
	function showPopbox(){
		$('#mled_pop_box').css('display', 'block');
	}// func
	// 取消添加输入框
	function hidePopbox(){
	...
	function addParamInfo(){
		var orgId = $('#orgId').val();
		if(isNaN($('input[name="mLed_addr"]').val()) || parseInt($('input[name="mLed_addr"]').val())>999){
			alert('<?php echo (($tmp = @$_smarty_tpl->tpl_vars['DEVICE_RIGHTER_MLED_TIP1']->value)===null||$tmp==='' ? "地址必须为数值，且不大于999" : $tmp);?>
');
			return;
		}
		var postData = getPostData($('.pop_box .tbAddParamInfo'));
		var url = "<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/index.php?control=device&action=addMledInfo";
		$.ajax({
			type: "post",
			url: url,
			dataType:'json',
...
');
	...
	// 根据设备类型和网点id找出设备的列表
	function getMledInfos(){
		var deviceStr = "";
		var orgId = $('#orgId').val();
		var url = "<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/index.php?control=device&action=getMledInfos";
		$.ajax({
			type: "post",
			url: url,
			dataType:'json',
			...
			success: function(data) {
				...
				for (var idx in deviceObjs){
					var sysno=deviceObjs[idx].mLed_sysno;
	...
	function generateDevice(deviceInfo){
		var device_key=$('#device_key').val();
		var paramStr = '<tr class="'+device_key+'_'+deviceInfo.mLed_sysno+'">'+
						  '<td class="tc"><input id="'+deviceInfo.mLed_mac+'" mLed_sysno="'+deviceInfo.mLed_sysno+'" class="optCheck" type="checkbox"/></td>'+
						  '<td>'+deviceInfo.mLed_mac+'</td>'+
						  '<td>'+deviceInfo.mLed_addr+'</td>'+
						  '<td>'+deviceInfo.mLed_counterNoArray+'</td>'+
						  '<td>'+deviceInfo.mled_zzsname+'</td>'+
						  '<td>'+deviceInfo.mled_zzsPhone+'</td>'+
						  '<td>'+deviceInfo.mled_fze+'</td>'+
						  '<td>'+deviceInfo.mled_bz+'</td>'+
						  //'<td>'+deviceInfo.mled_lrtime.substr(0, deviceInfo.mled_lrtime.indexOf('.'))+'</td>'+
						  //'<td>'+deviceInfo.mled_lasttime.substr(0, deviceInfo.mled_lasttime.indexOf('.'))+'</td>'+
						'</tr>';
		return paramStr;
	}// func
	...
	function editDeviceInfo(){
		...
		$('#tbDevice').find('input[type="checkbox"][class="optCheck"]').each(function(){
				if ('checked' == $(this).attr('checked')) 
				{
					...
					mLed_sysno= $(this).attr('mLed_sysno');
					checkedCnt++;
				}// if
		});
...
');
		...
		$('#mled_update_box').show();
		$("input[name='org_radio'][value="+mLed_sysno+"]").attr("checked",true);
		var i = 1;
		$('#'+paramId).parent().nextAll().each(function(){
			var content = $(this).html();
			switch (i){
				case 1:
					paramInfo.mLed_mac = content;
					$('#update_mLed_mac').val(content);
					//$(this).html('<input type="text" disabled name="mLed_mac" value="'+content+'"/>');
					break;
				case 2:
					paramInfo.mLed_addr = content;
					$('#update_mLed_addr').val(content);
					//$(this).html('<input type="text" name="mLed_addr" value="'+content+'"/>');
					break;
				case 3:
					paramInfo.mLed_counterNoArray = content;
					$('#update_mLed_counterNoArray').val(content);
					//$(this).html('<input type="text" name="mLed_counterNoArray" value="'+content+'"/>');
					break;
				case 4:
					paramInfo.mled_zzsname = content;
					$('#update_mled_zzsname').val(content);
					//$(this).html('<input type="text" name="mled_zzsname" value="'+content+'"/>');
					break;
				case 5:
					paramInfo.mled_zzsPhone = content;
					$('#update_mled_zzsPhone').val(content);
				//	$(this).html('<input type="text" name="mled_zzsPhone" value="'+content+'"/>');
					break;
				case 6:
					paramInfo.mled_fze = content;
					$('#update_mled_fze').val(content);
				//	$(this).html('<input type="text" name="mled_fze" value="'+content+'"/>');
					break;
				case 7:
					paramInfo.mled_bz = content;
					$('#update_mled_bz').val(content);
					//$(this).html('<textarea name="mled_bz" rows="4" cols="40">'+content+'</textarea>'+'&nbsp;<input class="btn_orange" type="button" value="<?php echo (($tmp = @$_smarty_tpl->tpl_vars['COMMON_BOX_SAVA']->value)===null||$tmp==='' ? "保存" : $tmp);?>
...
" onclick="resetParamInfo()">');
	...
	function saveParamInfo(){
		...
		var postData = getPostData($('#mled_update_box .tbAddParamInfo'));
		var url = "<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/index.php?control=device&action=saveMledInfo";
		$.ajax({
			type: "post",
			url: url,
			data: postData + "paramId=" + paramInfo.mLed_mac + '&orgId='+orgId,
			success: function(data) {
				if (data > 0)
				{
...
')) return;
		...
		var url = "<?php echo $_smarty_tpl->tpl_vars['baseUrl']->value;?>
/index.php?control=device&action=deleteMledInfo";
		$.ajax({
			type: "post",
			url: url,
			dataType:'json',

...
(function () {
     ...
     */
	//window.UEDITOR_HOME_URL = "/webmark/assets/ueditor/";
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [["fullscreen","undo","redo","insertunorderedlist","insertorderedlist","cleardoc","selectall","searchreplace","|","insertimage","date","time","horizontal","spechars","template","bold","italic","underline","strikethrough","forecolor","backcolor","superscript","subscript","justifyleft","justifycenter","justifyright","justifyjustify","touppercase","tolowercase","directionalityltr","directionalityrtl","indent","removeformat","autotypeset","fontfamily","fontsize","imagenone","imageleft","imageright","imagecenter","paragraph","lineheight","rowspacingtop","rowspacingbottom","inserttable","deletetable","mergeright","mergedown","splittorows","splittocols","splittocells","mergecells","insertcol","insertrow","deletecol","deleterow","insertparagraphbeforetable"]]

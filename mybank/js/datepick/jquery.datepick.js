...
function Datepicker() {
	...
	this.regional = {
		'': { // US/English
			...
			prevStatus: '显示上月', // Status text for the previous month command
			prevJumpText: '&lt;&lt;', // Text for the previous year command
			prevJumpStatus: '显示上一年', // Status text for the previous year command
			nextText: '下月&gt;', // Text for the next month command
			nextStatus: '显示下月', // Status text for the next month command
			nextJumpText: '&gt;&gt;', // Text for the next year command
			nextJumpStatus: '显示下一年', // Status text for the next year command
			currentText: '今天', // Text for the current month command
			...
			yearStatus: '选择年份', // Status text for year selection
			monthStatus: '选择月份', // Status text for month selection
			weekText: '周', // Text for week of the year column header
			weekStatus: '年内周次', // Status text for week of the year column header
			dayStatus: '选择 m月 d日, DD', // Status text for selectable days
			defaultStatus: '请选择日期', // Status text shown by default

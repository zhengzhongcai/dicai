...
//将一个新节点添加到node数组即dTree对象中的aNodes数组
...
//' + this.obj + '.o(' + nodeId + ')
		str += '<a href="javascript:alert(' + nodeId + ') ;" class="node">';
...
// Returns the selected node返回选中的节点
/***********************************************************************
 *作者：	kycool
 *时间：2012/7/13  16:08:07
 *参数：
 *描述：得到选中的节点
 *返回：如果选中节点在cookie文件中存在则返回节点，否则返回
			  null
 ***********************************************************************/
...
/***********************************************************************
 *作者：	kycool
 *时间：2012/7/13  15:58:16
 *参数：cookieName：cookie的名字
 *描述：得到cookie名为cookieName的值
 *返回：如果搜索到cookieName并且对应的值存在，返回对应的值
			  否则返回空值
 ***********************************************************************/

...
function setDefaultMainArea(info){
    ...
    var otherNodes =$("#apDiv1").children("div");
    for (var i = 0; i < otherNodes.length; i++)
    {
        if (otherNodes[i] != target)
        {
...
var program={
    canvas:"#apDiv1",
    info:{action:"add",em:"",profileName:"",profileOldName:"",profileType:"X86",profilePeriod:0,templateID:"",touchJumpUrl:"",tempWidth:"",tempHeight:"",tempBgGround:"",playAreaInfo:{}},
    ...
    saveInfo:function(){
        $.ajax({
            type:"POST",
            url:"../../../index.php?control=profile&action=createProfile",
...
program.edit={
    ...
    editTemplate:function(){
        ...
        art.dialog.open('index.php?control=c_templateManage&action=createTemp',{title: '编辑节目'+program.edit.oldInfo.programName+'模版',width:"90%",height:"99%", id:"editTemplateForProgram", lock:false,opacity:0.5,resize:false });
    },
    start:function(){
    ...
    ******************************************/
    ...
    deleteAreaForServer: function (areaID) {
        ...
        if (fileNames.length) {
            $.ajax({
                type: "post",
              //  url: "/bank/index.php?control=c_profileInfo&action=removeAreaFiles",
                url: "../../../index.php?control=c_profileInfo&action=removeAreaFiles",
                data: {
